...
public:
  LGFX(void)
  {
    ...
    { // Sets the display panel control.
      ...
      cfg.panel_height     =   240;  // The actual height that can be displayed
      cfg.offset_x         =    52;  // X-direction offset amount of panel
      cfg.offset_y         =    40;  // Panel Y-direction offset amount
