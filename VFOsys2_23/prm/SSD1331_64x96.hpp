...
public:
  LGFX(void)
  {
    { // // Configuring the SPI bus
      ...
      cfg.freq_write = 20000000;    // SPI clock at transmission (rounded to 80MHz, 80MHz divided by an integer)
    ...
    { // Sets the display panel control.
      ...
      cfg.panel_width      =   96;  // Actual displayable width
      cfg.panel_height     =   64;  // The actual height that can be displayed
      cfg.offset_x         =     0;  // X-direction offset amount of panel
      cfg.offset_y         =     0;  // Panel Y-direction offset amount
      cfg.offset_rotation  =     2;  // Offset of the value in the direction of rotation: 0~7 (4~7 inverts up and down)
      ...
      // cfg.memory_width = 96; // Maximum width supported by driver IC
      // cfg.memory_height = 64; // Maximum height supported by driver IC
